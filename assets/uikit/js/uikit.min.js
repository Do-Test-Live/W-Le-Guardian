...
(function (ve, we) {
    ...
    const Fo = /\B([A-Z])/g, Kt = dt(t => t.replace(Fo, "-$1").toLowerCase()), Ho = /-(\w)/g,
        be = dt(t => (t.charAt(0).toLowerCase() + t.slice(1)).replace(Ho, (e, i) => i.toUpperCase())),
    ...
    function bt(t) {
        return $e(t) || D(t) && !isNaN(t - parseFloat(t))
    }
    ...
    function P(t, e) {
        return [e] = Wi(e), !!e && k(t).some(i => i.classList.contains(e))
    }
    ...
    const Ro = /(^|[^\\],)\s*[!>+~-]/, Ds = dt(t => t.match(Ro));

    function Bs(t, e = document) {
        return D(t) && Ds(t) || Ge(e) ? e : e.ownerDocument
    }
        ...
        if (t = qo(t), Ds(t)) {
            ...
            for (let n of s) {
                ...
                if (n[0] === "!") {
                    ...
                    if (o = U(_(e), r[0]), n = r.slice(1).join(" ").trim(), !n.length && s.length === 1) return o
                }
                if (n[0] === "-") {
    ...
    function j(...t) {
        const [e, i, s, n, o = !1, r] = Yi(t), a = x(e, i, s, l => {
            const h = !r || r(l);
            h && (a(), n(l, h))
        }, o);
        return a
    ...
    function v(t, e, i) {
        return Gi(t).every(s => s.dispatchEvent(Mt(e, !0, !0, i)))
    }
    ...
    function Yi(t) {
        return t[0] = Gi(t[0]), D(t[1]) && (t[1] = t[1].split(" ")), it(t[2]) && t.splice(2, 0, !1), t
    }

    function Go(t, e) {
        return i => {
            const s = t[0] === ">" ? Te(t, i.currentTarget).reverse().filter(n => B(i.target, n))[0] : U(i.target, t);
    ...
    function Gi(t) {
        return Q(t) ? t.map(Ko).filter(Boolean) : D(t) ? Te(t) : Ns(t) ? [t] : k(t)
    }
    ...
    function c(t, e, i, s) {
        ...
        for (const o of n) if (D(e)) {
            ...
            o.style.setProperty(e, bt(i) && !Zo[e] ? `${i}px` : i || $e(i) ? i : "", s)
        } else if (Q(e)) {
            const r = {};
    ...
    function zs(t, e, i = 200, s, n) {
        return Promise.all(k(t).map(o => new Promise((r, a) => {
            ...
            j(o, "animationend animationcanceled", ({type: h}) => {
                clearTimeout(l), h === "animationcanceled" ? a() : r(o), c(o, "animationDuration", ""), Hi(o, `${Ee}\\S*`)
            }, {self: !0}), c(o, "animationDuration", `${i}ms`), y(o, e, Ee + (n ? "leave" : "enter")), ot(e, Ee) && (s && y(o, `uk-transform-origin-${s}`), n && y(o, `${Ee}reverse`))
        })))
    }

    const er = new RegExp(`${Ee}(enter|leave)`), gt = {
        in: zs, out(t, e, i, s) {
            return zs(t, e, i, s, !0)
        }, inProgress(t) {
    ...
    function b(t) {
        const e = ee(t) ? H(t).getBoundingClientRect() : {height: et(t), width: _e(t), top: 0, left: 0};
        return {
            height: e.height,
            width: e.width,
            top: e.top,
    ...
    const et = Ls("height"), _e = Ls("width");
    ...
    function he(t, e, i = "border-box") {
        return c(t, "boxSizing") === i ? Dt(Ft[e].map(Tt), s => $(c(t, `padding${s}`)) + $(c(t, `border${s}Width`))) : 0
    }
    ...
    const rr = /-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g, ar = dt(t => t.toString().replace(/\s/g, "").match(rr) || []),
        lr = /(?:v[hw]|%)$/, hr = dt(t => (t.match(lr) || [])[0]);
    ...
    const Lt = typeof window < "u", X = Lt && document.dir === "rtl", Wt = Lt && "ontouchstart" in window,
        ue = Lt && window.PointerEvent, mt = ue ? "pointerdown" : Wt ? "touchstart" : "mousedown",
        ai = ue ? "pointermove" : Wt ? "touchmove" : "mousemove", _t = ue ? "pointerup" : Wt ? "touchend" : "mouseup",
        Rt = ue ? "pointerenter" : Wt ? "" : "mouseenter", Oe = ue ? "pointerleave" : Wt ? "" : "mouseleave",
        li = ue ? "pointercancel" : "touchcancel", J = {
            reads: [], writes: [], read(t) {
    ...
    ts.prototype = {
        positions: [], init() {
            ...
            const e = t.getBoundingClientRect(), {left: i, right: s, top: n, bottom: o} = e, [r] = this.positions,
                a = ne(this.positions), l = [r, a];
            return Ze(a, e) ? !1 : [[{x: i, y: n}, {x: s, y: o}], [{x: i, y: o}, {x: s, y: n}]].some(u => {
                const f = dr(l, u);
                return f && Ze(f, e)
            })
        }
    ...
    function Vs(t) {
        if (ui(t) && is(t, {func: "playVideo", method: "play"}), ci(t)) try {
            t.play().catch(S)
        } catch {
        }
    }
    ...
    function Gs(t) {
        ui(t) && is(t, {func: "mute", method: "setVolume", value: 0}), ci(t) && (t.muted = !0)
    }
    ...
    function Qs(t, {offset: e = 0} = {}) {
        ...
        return i.reduce((r, a, l) => {
            const {scrollTop: h, scrollHeight: u, offsetHeight: f} = a, d = ct(a), g = u - d.height, {
                height: O,
                top: N
            } = i[l - 1] ? ct(i[l - 1]) : A(t);
    ...
    function os(t, e = 0, i = 0) {
        if (!R(t)) return 0;
        const s = Ct(t, !0), {scrollHeight: n, scrollTop: o} = s, {height: r} = ct(s), a = n - r,
            l = Ht(t)[0] - Ht(s)[0], h = Math.max(0, l - r + e), u = Math.min(a, l + t.offsetHeight - i);
        return Z((o - h) / (u - h))
    }
    ...
    function sn(t, e, i) {
        ...
        for (const [l, [h, , u, f]] of Object.entries(ut)) {
            ...
            if (r[l] === "flip") {
                ...
                g = Z(Z(s[u], d[u], d[f] - s[h]), O[u] - s[h] + N[l], O[f] - N[l]) - s[u]
            }
            a = rs(a, g, l)
        }
        return a
    ...
    function br(t, e, {offset: i, attach: s}, n) {
        return nn(t, e, {attach: {element: ln(s.element, n), target: ln(s.target, n)}, offset: xr(i, n)})
    }

    function $r(t, e, i) {
        return sn(t, e, {
            ...i,
            attach: {element: i.attach.element.map(hn).reverse(), target: i.attach.target.map(hn).reverse()},
    ...
    const kr = ["days", "hours", "minutes", "seconds"];
    var Sr = {
        mixins: [st],
    ...
    const V = {};
    V.events = V.watch = V.observe = V.created = V.beforeConnect = V.connected = V.beforeDisconnect = V.disconnected = V.destroy = as, V.args = function (t, e) {
        return e !== !1 && as(e || t)
    }, V.update = function (t, e) {
        return Ke(as(t, it(e) ? {read: e} : e), "order")
    ...
    function De(t, e, i) {
        const s = {};
        if (it(e) && (e = e.options), e.extends && (t = De(t, e.extends, i)), e.mixins) for (const o of e.mixins) t = De(t, o, i);
        for (const o in t) n(o);
        for (const o in e) vt(t, o) || n(o);

        function n(o) {
            s[o] = (V[o] || Cr)(t[o], e[o], i)
        }
    ...
    function ls(t, e) {
        return t === Boolean ? Bi(e) : t === Number ? kt(e) : t === "list" ? Tr(e) : t === Object && D(e) ? Be(e) : t ? t(e) : e
    }
    ...
    function di(t) {
        return ze((e, i) => ({disconnect: x(Pr(e), "scroll", i, {passive: !0, capture: !0})}), t, "scroll")
    }

    function dn(t) {
        return {
            observe(e, i) {
                return {observe: S, unobserve: S, disconnect: x(e, mt, i, {passive: !0})}
            }, handler(e) {
                if (!St(e)) return;
                const i = le(e), s = "tagName" in e.target ? e.target : _(e.target);
                j(document, `${_t} ${li} scroll`, n => {
                    const {x: o, y: r} = le(n);
                    (n.type !== "scroll" && s && o && Math.abs(i.x - o) > 100 || r && Math.abs(i.y - r) > 100) && setTimeout(() => {
                        v(s, "swipe"), v(s, `swipe${Er(i.x, i.y, o, r)}`)
                    })
                })
            }, ...t
        }
    ...
    var pn = {
        ...
        update: {
            read() {
                const t = hs(this.$el.children);
                return {rows: t, columns: _r(t)}
    ...
    function gn(t, e, i) {
        ...
        for (const n of t) {
            ...
            for (let r = s.length - 1; r >= 0; r--) {
                ...
                let l;
                if (a[0].offsetParent === n.offsetParent ? l = pi(a[0]) : (o = pi(n, !0), l = pi(a[0], !0)), o[e] >= l[i] - 1 && o[e] !== l[e]) {
                    s.push([n]);
                    break
                }
    ...
    const cs = "uk-transition-leave", us = "uk-transition-enter";

    function mn(t, e, i, s = 0) {
        const n = gi(e, !0), o = {opacity: 1}, r = {opacity: 0}, a = u => () => n === gi(e) ? u() : Promise.reject(),
            l = a(async () => {
                y(e, cs), await Promise.all(wn(e).map((u, f) => new Promise(d => setTimeout(() => E.start(u, r, i / 2, "ease").then(d), f * s)))), M(e, cs)
            }), h = a(async () => {
                const u = et(e);
                y(e, us), t(), c(T(e), {opacity: 0}), await Ar();
                const f = T(e), d = et(e);
                c(e, "alignContent", "flex-start"), et(e, u);
                const g = wn(e);
                c(f, r);
                const O = g.map(async (N, F) => {
                    await Or(F * s), await E.start(N, o, i / 2, "ease")
                });
                u !== d && O.push(E.start(e, {height: d}, i / 2 + g.length * s, "ease")), await Promise.all(O).then(() => {
                    M(e, us), n === gi(e) && (c(e, {
                        height: "",
                        alignContent: ""
        ...
        return P(e, cs) ? vn(e).then(h) : P(e, us) ? vn(e).then(l).then(h) : l().then(h)
    }

    function gi(t, e) {
        return e && (t.dataset.transition = 1 + gi(t)), kt(t.dataset.transition) || 0
    }
    ...
    function wn(t) {
        return hs(T(t)).reduce((e, i) => e.concat(Ke(i.filter(s => ns(s)), "offsetLeft")), [])
    }
    ...
    async function Dr(t, e, i) {
        ...
        const r = p(e, "style"), a = c(e, ["height", "padding"]), [l, h] = Br(e, s, n),
    ...
    function bn(t, e) {
        ...
        return R(t) ? {
            ...
            pointerEvents: "none",
            position: "absolute",
            zIndex: i === "auto" ? re(t) : i, ...$n(t)
        } : !1
    }

    function Br(t, e, i) {
        const s = e.map((o, r) => _(o) && r in i ? i[r] ? R(o) ? $n(o) : {opacity: 0} : {opacity: R(o) ? 1 : 0} : !1),
            n = s.map((o, r) => {
    ...
    function $n(t) {
        ...
        return {height: e, width: i, transform: "", ...Ki(t), ...c(t, ["marginTop", "marginLeft"])}
    }
    ...
    var yn = {
        ...
        methods: {
            animate(t, e = this.$el) {
                ...
                return (i === "fade" ? mn : i === "delayed-fade" ? (...n) => mn(...n, 40) : i ? Dr : () => (t(), Promise.resolve()))(t, e, this.duration).catch(S)
            }
        }
    };
    const I = {TAB: 9, ESC: 27, SPACE: 32, END: 35, HOME: 36, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40};
    var Nr = {
        mixins: [yn],
        args: "target",
        ...
        methods: {
            apply(t) {
                ...
                for (const i of this.toggles) q(i, this.cls, Hr(i, this.attrItem, t));
                await Promise.all(z(this.target, this.$el).map(i => {
                    const s = () => {
                        Fr(t, i, T(i)), this.$update(this.$el)
                    };
    ...
    function Sn(t, e, i) {
        ...
        return (s || Y(o)) && (n ? s ? (delete i.filter[""], i.filter[n] = s) : (delete i.filter[n], (xe(i.filter) || "" in i.filter) && (i.filter = {"": s || ""})) : i.filter = {"": s || ""}), Y(o) || (i.sort = [o, r]), i
    }

    function Hr(t, e, {filter: i = {"": ""}, sort: [s, n]}) {
        const {filter: o = "", group: r = "", sort: a, order: l = "asc"} = kn(t, e);
        return Y(a) ? r in i && o === i[r] || !o && r && !(r in i) && !i[""] : s === a && n === l
    }

    function Lr({filter: t}) {
        let e = "";
        return Pt(t, i => e += i || ""), e
    }

    function Wr(t, e, i) {
        return [...t].sort((s, n) => tt(s, e).localeCompare(tt(n, e), void 0, {numeric: !0}) * (i === "asc" || -1))
    }
    ...
    function In(t) {
        ...
        return c(i, {
            ...
            fs = !1, e(), c(i, {overflowY: "", touchAction: "", paddingRight: ""})
        }
    }
            ...
            async toggleElement(t, e, i) {
                try {
                    return await Promise.all(k(t).map(s => {
                        ...
                        const o = (it(i) ? i : i === !1 || !this.hasAnimation ? jr : this.hasTransition ? qr : Ur)(s, n, this),
    ...
    function jr(t, e, {_toggle: i}) {
        return gt.cancel(t), E.cancel(t), i(t, e)
    }

    async function qr(t, e, {animation: i, duration: s, velocity: n, transition: o, _toggle: r}) {
        var a;
        const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [],
            u = [["left", "right"], ["top", "bottom"]], f = u[m(u[0], h) ? 0 : 1], d = f[1] === h,
            O = ["width", "height"][u.indexOf(f)], N = `margin-${f[0]}`, F = `margin-${h}`;
        let Ot = b(t)[O];
        const Es = E.inProgress(t);
        await E.cancel(t), e && r(t, !0);
        const Gh = Object.fromEntries(["padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", N, F].map(zo => [zo, t.style[zo]])),
            Ye = b(t), Ps = $(c(t, N)), Bo = $(c(t, F)), Jt = Ye[O] + Bo;
        !Es && !e && (Ot += Bo);
        const [Oi] = Ji(t, "<div>");
        c(Oi, {
            boxSizing: "border-box",
            height: Ye.height,
            width: Ye.width, ...c(t, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", F])
        }), c(t, {
            padding: 0,
            border: 0,
            minWidth: 0,
        ...
        s = (n * Jt + s) * (e ? 1 - Mo : Mo);
        const No = {[O]: e ? Jt : 0};
        d && (c(t, N, Jt - Ot + Ps), No[N] = e ? Ps : Jt + Ps), !d ^ l === "reveal" && (c(Oi, N, -Jt + Ot), E.start(Oi, {[N]: e ? 0 : -Jt}, s, o));
        try {
            await E.start(t, No, s, o)
        } finally {
            c(t, Gh), Pe(Oi.firstChild), e || r(t, !1)
        }
    }
    ...
    var ds = {
        ...
        events: [{
            ...
            name: "show", self: !0, handler() {
                ...
                const t = [this.overlay && Yr(this), this.overlay && In(this.$el), this.bgClose && Gr(this), this.escClose && Xr(this)];
                j(this.$el, "hidden", () => t.forEach(e => e && e()), {self: !0}), y(document.documentElement, this.clsPage)
            }
        }, {
        ...
        methods: {
            toggle() {
                ...
                return this.container && _(this.$el) !== this.container ? (L(this.container, this.$el), new Promise(t => requestAnimationFrame(() => this.show().then(t)))) : this.toggleElement(this.$el, !0, Cn)
            }, hide() {
    ...
    function Gr(t) {
        return x(document, mt, ({target: e}) => {
            ne(nt) !== t || t.overlay && !B(e, t.$el) || B(e, t.panel) || j(document, `${_t} ${li} scroll`, ({
                                                                                                                 defaultPrevented: i,
                                                                                                                 type: s,
                                                                                                                 target: n
                                                                                                             }) => {
    ...
    function Jr(t, e, i, {animation: s, easing: n}) {
        const {percent: o, translate: r, show: a = S} = s, l = a(i);
        let h;
        return {
            dir: i, show(u, f = 0, d) {
                const g = d ? "linear" : n;
                return u -= Math.round(u * Z(f, -1, 1)), this.translate(f), mi(e, "itemin", {
                    percent: f,
                    duration: u,
                    timing: g,
                    dir: i
                }), mi(t, "itemout", {percent: 1 - f, duration: u, timing: g, dir: i}), new Promise(O => {
                    h || (h = O), Promise.all([E.start(e, l[1], u, g), E.start(t, l[0], u, g)]).then(() => {
                        this.reset(), h()
                    }, S)
                })
            }, cancel() {
                ...
                this.reset();
                const f = r(u, i);
                c(e, f[1]), c(t, f[0]), mi(e, "itemtranslatein", {
                    percent: u,
                    dir: i
                }), mi(t, "itemtranslateout", {percent: 1 - u, dir: i})
            }, percent() {
                return o(t || e, e, i)
            }, getDistance() {
    ...
    const gs = {passive: !1, capture: !0}, Tn = {passive: !0, capture: !0}, Zr = "touchstart mousedown",
        ms = "touchmove mousemove", En = "touchend touchcancel mouseup click input scroll";
    var Qr = {
        props: {draggable: Boolean}, data: {draggable: !0, threshold: 10}, created() {
            ...
            name: Zr, passive: !0, delegate() {
                return `${this.selList} > *`
            }, handler(t) {
                !this.draggable || !St(t) && ta(t.target) || U(t.target, ke) || t.button > 0 || this.length < 2 || this.start(t)
            }
        }, {
            ...
            start() {
                this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, x(document, ms, this.move, gs), x(document, En, this.end, Tn), c(this.list, "userSelect", "none")
            }, move(t) {
                ...
                if (Bt(document, ms, this.move, gs), Bt(document, En, this.end, Tn), this.dragging) if (this.dragging = null, this.index === this.prevIndex) this.percent = 1 - this.percent, this.dir *= -1, this._show(!1, this.index, !0), this._transitioner = null; else {
    ...
    function wi(t, e = "update") {
        t._connected && t._updates.length && (t._queued || (t._queued = new Set, J.read(() => {
            t._connected && na(t, t._queued), delete t._queued
    ...
    function oa(t) {
        t._watches = [];
        for (const e of t.$options.watch || []) for (const [i, s] of Object.entries(e)) Pn(t, s, i);
        t._initial = !0
    }
    ...
    function aa(t) {
        ...
        if (t._computed = {}, e) for (const i in e) _n(t, i, e[i])
    }
    ...
    function la(t) {
        t._hasComputed && (ia(t, {read: () => ra(t, An(t)), events: ["resize", "computed"]}), ca(), Le.add(t))
    }

    function ha(t) {
        Le == null || Le.delete(t), An(t)
    }
    ...
    function ca() {
        vs || (Le = new Set, vs = new MutationObserver(() => {
            for (const t of Le) wi(t, "computed")
        }), vs.observe(document, {childList: !0, subtree: !0}))
    }

    function ua(t) {
        t._events = [];
        for (const e of t.$options.events || []) if (vt(e, "handler")) ws(t, e); else for (const i in e) ws(t, e[i], i)
    }
    ...
    function ws(t, e, i) {
        ...
        if (n = it(n) ? n.call(t, t) : n || t.$el, Q(n)) {
            n.forEach(f => ws(t, {...e, el: f}, i));
            return
        }
        !n || h && !h.call(t) || t._events.push(x(n, s, l ? D(l) ? l : l.call(t, t) : null, D(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u
        }))
    ...
    function da(t) {
        t._observers = [];
        for (const e of t.$options.observe || []) if (vt(e, "handler")) Dn(t, e); else for (const i of e) Dn(t, i)
    }
    ...
    function Dn(t, e) {
        ...
        it(s) && Q(t[l]) && u.unobserve && Pn(t, {handler: ga(u), immediate: !1}, l), On(t, u)
    }
    ...
    function ma(t) {
        ...
        for (let s in t.$props) s in e && va(i, s) && (t[s] = t.$props[s])
    }
    ...
    function Bn(t) {
        ...
        for (const a in s) {
            const l = Kt(a);
            let h = tt(n, l);
            Y(h) || (h = s[a] === Boolean && h === "" ? !0 : ls(s[a], h), !(l === "target" && ot(h, "_")) && (e[a] = h))
        }
        const r = Be(tt(n, o), i);
        for (const a in r) {
            const l = be(a);
            Y(s[l]) || (e[l] = ls(s[l], r[a]))
        }
        return e
    }
    ...
    function wa(t) {
        ...
        const r = Object.keys(n), a = r.map(h => Kt(h)).concat(s), l = new MutationObserver(h => {
            ...
            h.some(({attributeName: f}) => {
                ...
                return (d === s ? r : [be(d), be(f)]).some(g => !Y(u[g]) && u[g] !== i[g])
            }) && t.$reset()
        });
        l.observe(o, {attributes: !0, attributeFilter: a.concat(a.map(h => `data-${h}`))}), On(t, l)
    }
    ...
    function bs(t) {
        t._connected || (ma(t), pe(t, "beforeConnect"), t._connected = !0, ua(t), ea(t), oa(t), da(t), wa(t), la(t), pe(t, "connected"), wi(t))
    }

    function $s(t) {
        t._connected && (pe(t, "beforeDisconnect"), fa(t), sa(t), pa(t), ha(t), pe(t, "disconnected"), t._connected = !1)
    }

    let ba = 0;

    function Mn(t, e = {}) {
        e.data = ya(e, t.constructor.options), t.$options = De(t.constructor.options, e, t), t.$props = {}, t._uid = ba++, $a(t), xa(t), aa(t), pe(t, "created"), e.el && t.$mount(e.el)
    }
    ...
    function ya({data: t = {}}, {args: e = [], props: i = {}}) {
        Q(t) && (t = t.slice(0, e.length).reduce((s, n, o) => (yt(n) ? wt(s, n) : s[e[o]] = n, s), {}));
        for (const s in t) Y(t[s]) ? delete t[s] : i[s] && (t[s] = ls(i[s], t[s]));
        return t
    }
    ...
    ft.util = yr, ft.options = {}, ft.version = "3.16.26";
    const ka = "uk-", Ut = "__uikit__", ge = {};

    function Nn(t, e) {
        var i;
        const s = ka + Kt(t);
        if (!e) return yt(ge[s]) && (ge[s] = ft.extend(ge[s])), ge[s];
        t = be(t), ft[t] = (o, r) => We(t, o, r);
        const n = yt(e) ? {...e} : e.options;
        return n.id = s, n.name = t, (i = n.install) == null || i.call(n, ft, n, t), ft._initialized && !n.functional && requestAnimationFrame(() => We(t, `[${s}],[data-${s}]`)), ge[s] = n
    }
    ...
    function Ia(t, e) {
        var i;
        (i = t[Ut]) == null || delete i[e.$options.name], xe(t[Ut]) || delete t[Ut]
    }

    function Ca(t) {
        t.component = Nn, t.getComponents = Vt, t.getComponent = bi, t.update = zn, t.use = function (i) {
            if (!i.installed) return i.call(null, this), i.installed = !0, this
        }, t.mixin = function (i, s) {
            s = (D(s) ? this.component(s) : s) || this, s.options = De(s.options, i)
        }, t.extend = function (i) {
            i || (i = {});
            const s = this, n = function (r) {
                Mn(this, r)
            };
            return n.prototype = Object.create(s.prototype), n.prototype.constructor = n, n.options = De(s.options, i), n.super = s, n.extend = s.extend, n
        };
        let e;
    ...
    function zn(t, e) {
        ...
        for (const i of oe(t).reverse()) Fn(i, e);
        It(t, i => Fn(i, e))
    }
    ...
    function Ta(t) {
        t.prototype.$mount = function (e) {
            const i = this;
            Sa(e, i), i.$options.el = e, B(e, document) && bs(i)
        }, t.prototype.$destroy = function (e = !1) {
            const i = this, {el: s} = i.$options;
            s && $s(i), pe(i, "destroy"), Ia(s, i), e && lt(i.$el)
        }, t.prototype.$create = We, t.prototype.$emit = function (e) {
            wi(this, e)
    ...
    var Ea = {
        ...
        methods: {
            show(t, e = !1) {
                ...
                const r = this.getIndex(this.index), a = P(this.slides, this.clsActive) && this.slides[r],
                    l = this.getIndex(t, this.index), h = this.slides[l];
                if (a === h) {
                    o();
                    return
                }
                if (this.dir = Pa(t, r), this.prevIndex = r, this.index = l, a && !v(a, "beforeitemhide", [this]) || !v(h, "beforeitemshow", [this, a])) {
                ...
                return new this.Transitioner($e(t) ? this.slides[t] : t, $e(e) ? this.slides[e] : e, i * (X ? -1 : 1), s)
            }
        }
    };
    ...
    var Wn = {
        ...
        data: {animation: "slide", clsActivated: "uk-transition-active", Animations: ps, Transitioner: Jr},
        computed: {
        ...
        ...ps, fade: {
            ...
            show() {
                return [{opacity: 0, transform: de(1 - .2)}, {opacity: 1, transform: de(1)}]
            }, percent(t) {
                return 1 - c(t, "opacity")
            }, translate(t) {
                return [{opacity: 1 - t, transform: de(1 - .2 * t)}, {opacity: t, transform: de(1 - .2 + .2 * t)}]
            }
        }
    }, jn = {
        mixins: [ds, Wn],
        ...
        events: [{name: `${ai} ${mt} keydown`, handler: "showControls"}, {
    ...
    var _a = {
        install: Aa, props: {toggle: String}, data: {toggle: "a"}, computed: {
            toggles({toggle: t}, e) {
                return z(t, e)
            }
        }, watch: {
    ...
    var Yn = {
        mixins: [$i], props: Zn(Vn(xi), "list"), data: Zn(Vn(xi), void 0), computed: {
            props(t, e) {
                const i = {};
                for (const n in t) n in xi && !Y(t[n]) && (i[n] = t[n].slice());
                const s = {};
                for (const n in i) s[n] = xi[n](n, e, i[n], i);
                return s
            }
        }, events: {
            load() {
    ...
    function yi(t, e, i) {
        let s = Si(i) || {x: "px", y: "px", rotate: "deg"}[t] || "", n;
        return t === "x" || t === "y" ? (t = `translate${Tt(t)}`, n = o => $($(o).toFixed(s === "px" ? 0 : 6))) : t === "scale" && (s = "", n = o => Si([o]) ? ht(o, "width", e, !0) / e.offsetWidth : $(o)), i.length === 1 && i.unshift(t === "scale" ? 1 : 0), i = me(i, n), (o, r) => {
            o.transform += ` ${t}(${je(i, r)}${s})`
        }
    }

    function xs(t, e, i) {
        return i.length === 1 && i.unshift(qe(e, t, "")), i = me(i, s => Ma(e, s)), (s, n) => {
            const [o, r, a] = Kn(i, n),
    ...
    function Yt(t, e, i) {
        ...
        const s = Si(i) || {blur: "px", hue: "deg"}[t] || "%";
    ...
    function Na(t, e, i) {
        return i.length === 1 && i.unshift(qe(e, t, "")), i = me(i), (s, n) => {
            s[t] = je(i, n)
        }
    }
    ...
    function Gn(t, e, i, s) {
        ...
        if (qe(e, "backgroundSize", "") === "cover") return Fa(t, e, i, s);
        const r = {};
    ...
    function Fa(t, e, i, s) {
        ...
        for (const u of r) {
            const f = s[u].map(([F]) => F), d = Math.min(...f), g = Math.max(...f), O = f.indexOf(d) < f.indexOf(g),
                N = g - d;
    ...
    function Si(t, e) {
        var i;
        for (const s of t) {
            const n = (i = s.match) == null ? void 0 : i.call(s, La);
            if (n) return n[1]
        }
        return e
    }
    ...
    var Wa = {
        ...
        observe: [fn(), di({target: ({target: t}) => t}), pt({target: ({$el: t, target: e}) => [t, e, Ct(e, !0)]})],
        update: {
            read({percent: t}, e) {
                if (e.has("scroll") || (t = !1), !R(this.$el)) return !1;
                if (!this.matchMedia) return;
                const i = t;
                return t = Ra(os(this.target, this.start, this.end), this.easing), {
                    percent: t,
    ...
    }, eo = {observe: Ne({target: ({slides: t}) => t, targets: t => t.getAdjacentSlides()})};

    function ja(t, e, i, {center: s, easing: n, list: o}) {
        ...
        return {
            dir: i, show(h, u = 0, f) {
                const d = f ? "linear" : n;
                return h -= Math.round(h * Z(u, -1, 1)), this.translate(u), u = t ? u : Z(u, 0, 1), ks(this.getItemIn(), "itemin", {
                    percent: u,
                    duration: h,
                    timing: d,
                    dir: i
                }), t && ks(this.getItemIn(!0), "itemout", {
                    percent: 1 - u,
                    duration: h,
                    timing: d,
                    dir: i
                }), new Promise(g => {
                    l || (l = g), E.start(o, {transform: W(-a * (X ? -1 : 1), "px")}, h, d).then(l, S)
                })
            }, cancel() {
                return E.cancel(o)
            }, reset() {
                ...
                c(o, "transform", W(Z(-a + (u - u * h), -Ii(o), b(o).width) * (X ? -1 : 1), "px"));
                const f = this.getActives(), d = this.getItemIn(), g = this.getItemIn(!0);
                h = t ? Z(h, -1, 1) : 0;
                for (const O of T(o)) {
                    const N = m(f, O), F = O === d, Ot = O === g,
                        Es = F || !Ot && (N || i * (X ? -1 : 1) === -1 ^ Ci(O, o) > Ci(t || e));
                    ks(O, `itemtranslate${Es ? "in" : "out"}`, {dir: i, percent: Ot ? 1 - h : F ? h : N ? 1 : 0})
                }
            }, percent() {
                ...
                let u = this.getActives(), f = so(o, Ue(e || t, o, s));
                if (h) {
                    const d = u;
                    u = f, f = d
                }
    ...
    function Ue(t, e, i) {
        const s = Ci(t, e);
        return i ? s - qa(t, e) : Math.min(s, io(e))
    }

    function io(t) {
        return Math.max(0, Ii(t) - b(t).width)
    }
    ...
    function so(t, e) {
        ...
        return T(t).filter(n => {
            const o = Ci(n, t), r = o + Math.min(b(n).width, i);
            return o >= e && r <= s
        })
    }
    ...
    var Ua = {
        ...
        computed: {
            avgWidth() {
                return Ii(this.list) / this.length
            }, finite({finite: t}) {
                return t || Va(this.list, this.center)
            }, maxIndex() {
        ...
        methods: {
            reorder() {
                ...
                const {width: t} = b(this.list), e = -t, i = t * 2, s = b(this.slides[this.index]).width,
    ...
    function Va(t, e) {
        ...
        const {width: i} = b(t);
        if (!e) return Math.ceil(Ii(t)) < Math.trunc(i + Ya(t));
        const s = T(t), n = Math.trunc(i / 2);
        for (const o in s) {
            const r = s[o], a = b(r).width, l = new Set([r]);
            let h = 0;
            for (const u of [-1, 1]) {
                let f = a / 2, d = 0;
                for (; f < n;) {
    ...
    var no = {
        mixins: [Yn], data: {selItem: "!li"}, beforeConnect() {
            ...
            name: "itemin itemout", self: !0, el() {
                ...
                J.read(() => {
                    if (!this.matchMedia) return;
                    const o = this.getCss(ro(t, n, e)), r = this.getCss(oo(t) ? .5 : n > 0 ? 1 : 0);
                    J.write(() => {
    ...
    var Ga = {
        ...ps, fade: {
            ...
            show() {
                return [{opacity: 0, transform: de(1 + .5), zIndex: 0}, {zIndex: -1}]
            }, percent(t) {
                return 1 - c(t, "opacity")
            }, translate(t) {
                return [{opacity: 1 - t, transform: de(1 + .5 * t), zIndex: 0}, {zIndex: -1}]
            }
        }, pull: {
            show(t) {
        ...
        update: {
            write(t) {
                ...
                const l = tl(a, {x: e, y: i});
                if (a.length && (!l || l === o)) return;
                const h = this.getSortable(o), u = el(r.target, l, o, e, i, r === h && t.moved !== l);
        ...
        methods: {
            init(t) {
                ...
                !n || s || i > 0 || ji(e) || B(e, `.${this.clsNoDrag}`) || this.handle && !B(e, this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                    target: e,
                    index: re(n), ...this.pos
                }, x(document, ai, this.move), x(document, _t, this.end), this.threshold || this.start(t))
            }, start(t) {
                this.drag = Qa(this.$container, this.placeholder);
                const {left: e, top: i} = this.placeholder.getBoundingClientRect();
                wt(this.origin, {
                    offsetLeft: this.pos.x - e,
                    offsetTop: this.pos.y - i
                }), y(this.drag, this.clsDrag, this.clsCustom), y(this.placeholder, this.clsPlaceholder), y(this.items, this.clsItem), y(document.documentElement, this.clsDragState), v(this.$el, "start", [this, this.placeholder]), Ka(this.pos), this.move(t)
            }, move(t) {
                this.drag ? this.$emit("move") : (Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(t)
            }, end() {
                if (Bt(document, ai, this.move), Bt(document, _t, this.end), !this.drag) return;
                Za();
    ...
    function el(t, e, i, s, n, o) {
        ...
        if (!o) return il(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
        const a = i.getBoundingClientRect(),
            l = lo([r.top, r.bottom], [a.top, a.bottom]), [h, u, f, d] = l ? [s, "width", "left", "right"] : [n, "height", "top", "bottom"],
            g = a[u] < r[u] ? r[u] - a[u] : 0;
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const n = [this.flip && "flip", this.shift && "shift"],
                    o = {element: [this.inset ? this.dir : ri(this.dir), this.align], target: [this.dir, this.align]};
                if (this.axis === "y") {
        ...
        methods: {
            show() {
                ...
                this.tooltip = L(this.container, `<div id="${this.id}" class="uk-${this.$options.name}" role="tooltip"> <div class="uk-${this.$options.name}-inner">${this.title}</div> </div>`), x(this.tooltip, "toggled", (t, e) => {
                    ...
                    i();
                    const [s, n] = rl(this.tooltip, this.$el, this.pos);
                    this.origin = this.axis === "y" ? `${ri(s)}-${n}` : `${n}-${ri(s)}`;
                    const o = [j(document, `keydown ${mt}`, this.hide, !1, r => r.type === mt && !B(r.target, this.$el) || r.type === "keydown" && r.keyCode === I.ESC), x([document, ...jt(this.$el)], "scroll", i, {passive: !0})];
                    j(this.tooltip, "hide", () => o.forEach(r => r()), {self: !0})
                }), await this.toggleElement(this.tooltip, !0) || this.hide()
            }
        },
        events: {
            focus: "show", blur: "hide", [`${Rt} ${Oe}`](t) {
    ...
    function rl(t, e, [i, s]) {
        const n = A(t), o = A(e), r = [["left", "right"], ["top", "bottom"]];
        for (const l of r) {
            if (n[l[0]] >= o[l[1]]) {
                i = l[1];
                break
    ...
    var al = {
        ...
        events: {
            change(t) {
                ...
                Ti(t), y(this.$el, this.clsDragover)
            }, dragleave(t) {
                Ti(t), M(this.$el, this.clsDragover)
            }
        },
        methods: {
            async upload(t) {
    ...
    function hl(t, e) {
        ...
        return Promise.resolve().then(() => i.beforeSend(i)).then(() => cl(t, i))
    }
    ...
    function uo(t) {
        v(document, "uikit:init", t), document.body && It(document.body, fo), new MutationObserver(e => e.forEach(dl)).observe(document, {
            childList: !0,
            subtree: !0
    ...
    function dl({addedNodes: t, removedNodes: e}) {
        for (const i of t) It(i, fo);
        for (const i of e) It(i, gl)
    }

    function pl({target: t, attributeName: e}) {
        var i;
        const s = po(e);
        if (s) {
            if ($t(t, e)) {
    ...
    var go = {
        ...
        events: [{
            name: "click keydown", delegate() {
                ...
                var e;
                t.type === "keydown" && t.keyCode !== I.SPACE || (t.preventDefault(), (e = this._off) == null || e.call(this), this._off = vl(t.target), await this.toggle(re(this.toggles, t.current)), this._off())
            }
        }, {
    ...
    async function ml(t, e, {content: i, duration: s, velocity: n, transition: o}) {
        var r;
        i = ((r = t._wrapper) == null ? void 0 : r.firstElementChild) || w(i, t), t._wrapper || (t._wrapper = oi(i, "<div>"));
        const a = t._wrapper;
        c(a, "overflow", "hidden");
        const l = $(c(a, "height"));
        await E.cancel(a), Ei(i, !1);
        const h = Dt(["marginTop", "marginBottom"], f => c(i, f)) + b(i).height, u = l / h;
        s = (n * h + s) * (e ? 1 - u : u), c(a, "height", l), await E.start(a, {height: e ? h : 0}, s, o), Pe(i), delete t._wrapper, e || Ei(i, !0)
    }
    ...
    var mo = {
        ...
        update: {
            read({visible: t}) {
                return Xs(this.$el) ? {prev: t, visible: R(this.$el), inView: this.inView && ns(this.$el)} : !1
        ...
        observe: pt({target: ({$el: t}) => [vo(t) || _(t)]}),
        update: {
            read() {
                ...
                const {offsetHeight: r, offsetWidth: a} = vo(i) || _(i),
    ...
    function vo(t) {
        for (; t = _(t);) if (c(t, "position") !== "static") return t
    }
    ...
    var wo = {
        ...
        connected() {
            y(this.$el, "uk-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = kl(this)), this._style = Ni(this.$el.style, ["width", "height"])
        },
        disconnected() {
            this.isActive() && (this.hide(!1), K = null), c(this.$el, this._style)
        },
        observe: Ne({target: ({toggle: t, $el: e}) => at(t, e), targets: ({$el: t}) => t}),
        events: [{
            name: "click", delegate() {
            ...
            name: `${Rt} focusin`, filter() {
                return m(this.mode, "hover")
            }, handler(t) {
                St(t) || this.clearTimers()
            }
        }, {
            name: `${Oe} focusout`, filter() {
                return m(this.mode, "hover")
            }, handler(t) {
            ...
            name: "show", self: !0, handler() {
                ...
                const t = [Sl(this), Cl(this), Tl(this), this.autoUpdate && Il(this), !this.bgScroll && In(this.$el)];
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), this.targetEl = t, this.clearTimers(), !this.isActive()) {
                    ...
                    this.container && _(this.$el) !== this.container && L(this.container, this.$el), this.showTimer = setTimeout(() => this.toggleElement(this.$el, !0), e && this.delayShow || 0)
                }
            }, hide(t = !0, e = !0) {
                const i = () => this.toggleElement(this.$el, !1, this.animateOut && e);
                this.clearTimers(), this.isDelaying = xl(this.$el).some(s => this.tracker.movesTo(s)), t && this.isDelaying ? this.hideTimer = setTimeout(this.hide, 50) : t && this.delayHide ? this.hideTimer = setTimeout(i, this.delayHide) : i()
            }, clearTimers() {
                ...
                const t = this.target.map(n => yl(this.$el, n)), e = this.getViewportOffset(this.$el),
                ...
                for (const [n, [o, r, a, l]] of i) if (this.axis === o && m([o, !0], this.stretch)) {
                    ...
                    c(this.$el, {
                        [r]: (u[a] > f[a] ? u[this.inset ? l : a] - Math.max(A(this.boundary[n])[a], t[n][a] + e) : Math.min(A(this.boundary[n])[l], t[n][l] - e) - u[this.inset ? a : l]) - h,
                        [`overflow-${o}`]: "auto"
    ...
    function kl(t) {
        const {$el: e} = t.$create("toggle", at(t.toggle, t.$el), {target: t.$el, mode: t.mode});
        return p(e, "aria-haspopup", !0), e
    }

    function Sl(t) {
        const e = () => t.$emit(), i = [es(e), hi(jt(t.$el).concat(t.target), e)];
    ...
    function Tl(t) {
        return x(document, mt, ({target: e}) => {
            B(e, t.$el) || j(document, `${_t} ${li} scroll`, ({defaultPrevented: i, type: s, target: n}) => {
    ...
    var bo = {
        ...
        events: [{
            ...
            name: "keydown", self: !0, delegate() {
                ...
                s === I.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(), (e = w(Se, n.$el)) == null || e.focus()), $o(t, this.items, n)
            }
        }, {
            name: "keydown", el() {
            ...
            name: "show", el() {
                ...
                const e = this.getDropdown(t), i = () => {
                    const s = oe(t, `.${this.clsDrop}`).concat(t).map(a => A(a)),
        ...
        methods: {
            getActive() {
                ...
                e = s < t && e, await E.cancel([e, i]), c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`), et(i, s), await Promise.all([E.start(i, {height: t}, this.duration), E.start(e, {clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)`}, this.duration).finally(() => c(e, {clipPath: ""}))]).catch(S)
            }, getDropdown(t) {
    ...
    var El = {
        mixins: [st], args: "target", props: {target: Boolean}, data: {target: !1}, computed: {
            input(t, e) {
                return w(ke, e)
            }, state() {
            ...
            if (!e) return;
            let s;
            const n = ji(e) ? "value" : "textContent", o = e[n],
        ...
        observe: di({filter: ({parallax: t}) => t}),
        update: [{
            write({columns: t}) {
            ...
            read(t) {
                ...
                if (!e.length || !this.masonry && !this.parallax || xo(this.$el)) return t.translates = !1, !1;
                let s = !1;
                const n = T(this.$el), o = e.map(h => Dt(h, "offsetHeight")), r = Al(n, this.margin) * (i.length - 1),
                    a = Math.max(...o) + r;
                this.masonry && (e = e.map(h => Ke(h, "offsetTop")), s = _l(i, e));
            ...
            read() {
                return this.parallax && xo(this.$el) ? !1 : {scrolled: this.parallax ? os(this.$el) * Math.abs(this.parallax) : !1}
    ...
    var Ol = {
        ...
        update: {
            read() {
                return {rows: (this.row ? hs(this.elements) : [this.elements]).map(Dl)}
            }, write({rows: t}) {
    ...
    var Ml = {
            ...
            update: {
                read() {
                    ...
                    let t = "";
                    const e = he(this.$el, "height", "content-box"), {body: i, scrollingElement: s} = document,
                        n = Ct(this.$el), {height: o} = ct(n === i ? s : n);
        ...
        Nl = '<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-width="1.1" x1="1" y1="1" x2="13" y2="13"/><line fill="none" stroke="#000" stroke-width="1.1" x1="13" y1="1" x2="1" y2="13"/></svg>',
        zl = '<svg width="20" height="20" viewBox="0 0 20 20"><line fill="none" stroke="#000" stroke-width="1.4" x1="1" y1="1" x2="19" y2="19"/><line fill="none" stroke="#000" stroke-width="1.4" x1="19" y1="1" x2="1" y2="19"/></svg>',
        Fl = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        Hl = '<svg width="20" height="20" viewBox="0 0 20 20"><rect x="9" y="4" width="1" height="11"/><rect x="4" y="9" width="11" height="1"/></svg>',
        Ll = '<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 4 7 10 13 4"/></svg>',
        Wl = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        Rl = '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
        jl = '<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-animate svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle svg&gt;.line-3{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect class="line-1" y="3" width="20" height="2"/><rect class="line-2" y="9" width="20" height="2"/><rect class="line-3" y="9" width="20" height="2"/><rect class="line-4" y="15" width="20" height="2"/></svg>',
        ql = '<svg width="40" height="40" viewBox="0 0 40 40"><rect x="19" y="0" width="1" height="40"/><rect x="0" y="19" width="40" height="1"/></svg>',
        Ul = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 6 6 1 11"/></svg>',
        Vl = '<svg width="7" height="12" viewBox="0 0 7 12"><polyline fill="none" stroke="#000" stroke-width="1.2" points="6 1 1 6 6 11"/></svg>',
        Yl = '<svg width="20" height="20" viewBox="0 0 20 20"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"/><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"/></svg>',
        Gl = '<svg width="40" height="40" viewBox="0 0 40 40"><circle fill="none" stroke="#000" stroke-width="1.8" cx="17.5" cy="17.5" r="16.5"/><line fill="none" stroke="#000" stroke-width="1.8" x1="38" y1="39" x2="29" y2="30"/></svg>',
        Xl = '<svg width="24" height="24" viewBox="0 0 24 24"><circle fill="none" stroke="#000" stroke-width="1.1" cx="10.5" cy="10.5" r="9.5"/><line fill="none" stroke="#000" stroke-width="1.1" x1="23" y1="23" x2="17" y2="17"/></svg>',
        Jl = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="4.002,38.547 22.527,20.024 4,1.5"/></svg>',
        Kl = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1"/></svg>',
        Zl = '<svg width="25" height="40" viewBox="0 0 25 40"><polyline fill="none" stroke="#000" stroke-width="2" points="20.527,1.5 2,20.024 20.525,38.547"/></svg>',
        Ql = '<svg width="14" height="24" viewBox="0 0 14 24"><polyline fill="none" stroke="#000" stroke-width="1.4" points="12.775,1 1.225,12 12.775,23"/></svg>',
        ...
        yo = {
            args: "src", props: {width: Number, height: Number, ratio: Number}, data: {ratio: 1}, connected() {
                this.svg = this.getSvg().then(t => {
                    ...
                    const e = ih(t, this.$el);
                    return this.svgEl && e !== this.svgEl && lt(this.svgEl), sh.call(this, e, t), this.svgEl = e
                }, S)
            }, disconnected() {
                this.svg.then(t => {
                    this._connected || (Ri(this.$el) && (this.$el.hidden = !1), lt(t), this.svgEl = null)
                }), this.svg = null
            }, methods: {
                async getSvg() {
                }
    ...
    const Pi = {
            ...
            "navbar-parent-icon": Rl,
            "navbar-toggle-icon": jl,
            "overlay-icon": ql,
            "pagination-next": Ul,
            "pagination-previous": Vl,
            "search-icon": Yl,
            "search-large": Gl,
            "search-navbar": Xl,
            "slidenav-next": Kl,
            "slidenav-next-large": Jl,
            "slidenav-previous": Ql,
            "slidenav-previous-large": Zl
        }, Ss = {
            install: dh, mixins: [yo], args: "icon", props: {icon: String}, isIcon: !0, beforeConnect() {
                y(this.$el, "uk-icon")
            }, methods: {
                async getSvg() {
                    const t = ph(this.icon);
                    if (!t) throw "Icon not found.";
                    return t
                }
            }
        }, Gt = {
            args: !1, extends: Ss, data: t => ({icon: Kt(t.constructor.options.name)}), beforeConnect() {
                y(this.$el, this.$options.id)
            }
        }, nh = {
            extends: Gt, beforeConnect() {
                const t = this.$props.icon;
                this.icon = U(this.$el, ".uk-nav-primary") ? `${t}-large` : t
            }
        }, oh = {
            extends: Gt, mixins: [vi], i18n: {toggle: "Open Search", submit: "Submit Search"}, beforeConnect() {
            ...
            extends: Gt, mixins: [vi], beforeConnect() {
                const t = U(this.$el, "a,button");
            ...
            extends: Xt, beforeConnect() {
                y(this.$el, "uk-slidenav");
                const t = this.$props.icon;
                this.icon = P(this.$el, "uk-slidenav-large") ? `${t}-large` : t
            }
        }, ah = {extends: Xt, i18n: {label: "Open menu"}}, lh = {
            extends: Xt, i18n: {label: "Close"}, beforeConnect() {
                this.icon = `close-${P(this.$el, "uk-close-large") ? "large" : "icon"}`
            }
        }, hh = {extends: Xt, i18n: {label: "Open"}}, ch = {extends: Xt, i18n: {label: "Back to top"}},
        uh = {extends: Xt, i18n: {label: "Next page"}, data: {role: null}},
        fh = {extends: Xt, i18n: {label: "Previous page"}, data: {role: null}}, _i = {};
    ...
    function ph(t) {
        return Pi[t] ? (_i[t] || (_i[t] = w((Pi[gh(t)] || Pi[t]).trim())), _i[t].cloneNode(!0)) : null
    }
    ...
    const mh = Lt && "loading" in HTMLImageElement.prototype;
    var vh = {
        args: "dataSrc",
        ...
        connected() {
            ...
            mh && Ai(this.$el) && (this.$el.loading = "lazy", Is(this.$el)), yh(this.$el)
        },
        disconnected() {
            this.img && (this.img.onload = ""), delete this.img
        },
        observe: Me({
            target: ({$el: t, $props: e}) => [t, ...Ce(e.target, t)], handler(t, e) {
        ...
        methods: {
            load() {
                ...
                const t = Ai(this.$el) ? this.$el : bh(this.$el, this.dataSrc, this.sources);
                return ye(t, "loading"), Is(this.$el, t.currentSrc), this.img = t
            }
        }
    };
    ...
    function Is(t, e) {
        ...
        } else e && !m(t.style.backgroundImage, e) && (c(t, "backgroundImage", `url(${Vi(e)})`), v(t, Mt("load", !1)))
    }
    ...
    function yh(t) {
        Ai(t) && !$t(t, "src") && p(t, "src", 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>')
    }
    ...
    var Ch = {extends: go, data: {targets: "> .uk-parent", toggle: "> a", content: "> ul"}}, Th = {
        extends: bo,
        data: {
        ...
        events: [{
            ...
            name: "show", self: !0, handler() {
                this.mode === "reveal" && !P(_(this.panel), this.clsMode) && (oi(this.panel, "<div>"), y(_(this.panel), this.clsMode));
                const {body: t, scrollingElement: e} = document;
                y(t, this.clsContainer, this.clsFlip), c(t, "touch-action", "pan-y pinch-zoom"), c(this.$el, "display", "block"), c(this.panel, "maxWidth", e.clientWidth), y(this.$el, this.clsOverlay), y(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), et(t), y(t, this.clsContainerAnimation), this.clsContainerAnimation && Ph()
            }
        }, {
            name: "hide", self: !0, handler() {
            ...
            name: "hidden", self: !0, handler() {
                this.clsContainerAnimation && _h(), this.mode === "reveal" && Pe(this.panel), M(this.panel, this.clsSidebarAnimation, this.clsMode), M(this.$el, this.clsOverlay), c(this.$el, "display", ""), c(this.panel, "maxWidth", ""), M(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    var Ah = {
        ...
        update: {
            read() {
                return !this.content || !this.container || !R(this.$el) ? !1 : {max: Math.max(this.minHeight, et(this.container) - (b(this.content).height - et(this.$el)))}
            }, write({max: t}) {
        ...
        }, observe: pt({target: ({$el: t}) => [t, _(t)]}), update: {
            read() {
                return R(this.$el) && this.width && this.height ? {width: _e(_(this.$el)), height: this.height} : !1
            }, write(t) {
                et(this.$el, Qe.contain({height: this.height, width: this.width}, t).height)
            }, events: ["resize"]
        }
    }, Dh = {
    ...
    function Bh(t) {
        Ve.size || x(document, "click", To), Ve.add(t)
    }

    function Mh(t) {
        Ve.delete(t), Ve.size || Bt(document, "click", To)
    }

    function To(t) {
        if (!t.defaultPrevented) for (const e of Ve) B(t.target, e.$el) && ae(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(qi(e.$el)))
    }
    ...
    var Nh = {
        ...
        observe: Me({
            target: ({elements: t}) => t, handler(t) {
                ...
                this.$emit()
            }, options: t => ({rootMargin: t.margin}), args: {intersecting: !1}
        }),
        update: [{
            write(t) {
        ...
        observe: [fn(), di({target: () => document.scrollingElement}), pt({target: ({$el: t}) => [t, document.scrollingElement]})],
        events: [{
            ...
            name: "transitionstart", capture: !0, handler() {
        ...
        update: [{
            read({height: t, width: e, margin: i, sticky: s}) {
                ...
                n && (_o(this.selTarget), this.hide()), this.active || ({
                    height: t,
                    width: e
                } = A(this.$el), i = c(this.$el, "margin")), n && this.show();
                ...
                const f = this.overflowFlip ? 0 : Math.max(0, t + u - o), d = A(h).top, g = A(this.$el).height,
                    O = (this.start === !1 ? d : Cs(this.start, this.$el, d)) - u,
                    N = this.end === !1 ? a : Math.min(a, Cs(this.end, this.$el, d + t, !0) - g - u + f);
                return s = a && !this.showOnUp && O + u === d && N === Math.min(a, Cs("!*", this.$el, 0, !0) - g - u + f) && c(_(this.$el), "overflowY") === "visible", {
                    start: O,
                    end: N,
                    offset: u,
                    overflow: f,
                ...
                if ((this.inactive || n || !this.isFixed) && Po(this.$el), this.inactive) return;
                n && (t = e = i = 0, c(this.$el, {position: "sticky", top: s}));
                const {placeholder: o} = this;
                c(o, {height: t, width: e, margin: i}), B(o, document) || (o.hidden = !0), (n ? ii : si)(this.$el, o)
            }, events: ["resize"]
        }, {
            read({scroll: t = 0, dir: e = "down", overflow: i, overflowScroll: s = 0, start: n, end: o}) {
                ...
                } else this.isFixed ? this.update() : this.animation && r > u ? (gt.cancel(this.$el), this.show(), gt.in(this.$el, this.animation).catch(S)) : (_o(this.selTarget), this.show())
        ...
        methods: {
            show() {
                ...
                const e = this.active;
                this.active = t, t ? (Li(this.selTarget, this.clsInactive, this.clsActive), e !== t && v(this.$el, "active")) : (Li(this.selTarget, this.clsActive, this.clsInactive), e !== t && v(this.$el, "inactive"))
            }
        }
    };
    ...
    var Hh = {
        ...
        async connected() {
            ...
            const t = await this.svg;
            t && (Ao.call(this, t), this.strokeAnimation && jh(t))
        },
        methods: {
            async getSvg() {
                return G(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" ? new Promise(t => j(this.$el, "load", () => t(this.getSvg()))) : Wh(await Lh(this.src), this.icon) || Promise.reject("SVG not found.")
            }
        }
    };
    ...
    const Lh = dt(async t => t ? ot(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text() : Promise.reject());

    function Wh(t, e) {
        return e && m(t, "<symbol") && (t = Rh(t)[e] || t), t = w(t.substr(t.indexOf("<svg"))), (t == null ? void 0 : t.hasChildNodes()) && t
    }

    const Oo = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g, Rh = dt(function (t) {
        const e = {};
        Oo.lastIndex = 0;
        let i;
        for (; i = Oo.exec(t);) e[i[3]] = `<svg ${i[1]}svg>`;
        return e
    });
    ...
    const Ts = ".uk-disabled *, .uk-disabled, [disabled]";
    var Do = {
        mixins: [qt],
        args: "connect",
        props: {
        ...
        observe: [Ne({targets: ({connectChildren: t}) => t}), dn({
            target: ({connects: t}) => t,
            filter: ({swiping: t}) => t
        })],
        events: [{
            name: "click keydown", delegate() {
                ...
                !C(t.current, Ts) && (t.type === "click" || t.keyCode === I.SPACE) && (t.preventDefault(), this.show(t.current))
            }
        }, {
            name: "keydown", delegate() {
                return this.toggle
                ...
                if (~n) {
                    t.preventDefault();
                    const o = this.toggles.filter(a => !C(a, Ts)), r = o[rt(n, o, o.indexOf(e))];
        ...
        methods: {
            index() {
                ...
                const e = this.toggles.filter(r => !C(r, Ts)), i = this.index(),
                    s = rt(!Xe(t) || m(e, t) ? t : 0, e, rt(this.toggles[i], e)), n = rt(e[s], this.toggles);
    ...
    var Vh = {
        ...
        events: [{
            ...
            name: `mouseenter mouseleave ${Rt} ${Oe} focus blur`, filter() {
                return m(this.mode, "hover")
            }, handler(t) {
    ...
    return Pt(Yh, (t, e) => ft.component(e, t)), fl(ft), Pt(ul, (t, e) => ft.component(e, t)), ft
});
