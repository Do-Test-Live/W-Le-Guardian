                ...
                <div class="col-lg-10 d-flex justify-content-center align-items-center order-1 order-lg-0" style="background-image: url('assets/images/wealth/1.png'); background-repeat: no-repeat; background-position: center; background-size: cover;">
                    <div class="p-lg-5 p-3">
                        ...
                        if($_SESSION['lan'] == 'CN'){
                            ...
                            ?>
                            <p class="mb-3">When families engage in the design of wealth succession planning, it is important for them to grasp how to enhance their inheritance strategies to match their own preferences and fulfill specific requirements.
                            </p>
                            <p class="mb-3">
                                What are the effective ways for families and their heirs to transfer wealth using life insurance?
                            </p>
                            <p>
                                The Wealth Succession Planning team at Le Guardien Family Office conducts thorough professional analysis for each high-net-worth client, with the goal of developing the most optimal wealth succession plan through the utilization of diverse tools, including trusts and life insurance.
                            </p>
                            <?php
                        }
                        ?>
